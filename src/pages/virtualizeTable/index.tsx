...
export default function VirtualizedChat() {
  return (
    <Paper sx={{ height: 500, width: '90vW', mt: 4 }}>
...
// import VirtualizedMuiTable from '@/components/VirtualizedMuiTable';
// import { Container, Typography } from '@mui/material';

// export default function VirtualizedMuiTableShow() {
//   return (
//     <Container sx={{ mt: 4 }}>
//       <Typography variant="h5" gutterBottom>
//         Virtualized MUI Table (react-window)
//       </Typography>
//       <VirtualizedMuiTable />
//     </Container>
//   );
